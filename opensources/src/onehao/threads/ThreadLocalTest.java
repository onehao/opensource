...
//					myThreadScopeData.set(mydata);
					MyThreadScopeData.getInstance().setName("name" + dataa);
					MyThreadScopeData.getInstance().setAge(dataa);
					new A().get();
					new B().get();
				}
			}).start();
...
//				System.out.println("A from " + mydata.getName() + "," + mydata.getAge());
	...
	static class B {
		public void get() {
			...
			System.out.println("B from " + Thread.currentThread().getName()
					+ " has get data : " + data);
//			MyThreadScopeData mydata = myThreadScopeData.get();
//			System.out.println("B from " + mydata.getName() + "," + mydata.getAge());
			MyThreadScopeData mydata = MyThreadScopeData.getInstance();
			System.out.println("B from " + mydata.getName() + "," + mydata.getAge());
		}
	}
