package onehao.java.collections;
...
public class HashCompare {
	...
	public static void main(String[] args) {
		...
		MyHashMap<Integer, Object> map = new MyHashMap<Integer, Object>();

		// check when reach 12 the sequence will be changed.
		for (int i = 0; i < 16; i++) {
			map.put(i * i, null);
		...
		// inserting 16 elements then there will be 32 slots in the chunk.
		// as for i*i (0 - 16), what's the hash sequence of for hash = value %
		// size(=32)
		/*
		 * *
		 * 0 1 4 9 16 25 36 49 64 81 100 121 144 169 196 225 256 0 1 4 9 16 25 4
		 * 17 0 17 4 25 16 9 0 1 0
		 */
	...
	public Object clone() {
		...
		if (result.table != EMPTY_TABLE) {
			result.inflateTable(Math.min(
					...
					// we have limits...
							MyHashMap.MAXIMUM_CAPACITY), table.length));
		}
