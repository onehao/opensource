...
public class Indexer {
	...
	final static String wsIndexDir = "D:\\workspace\\opensource\\lucene\\liaIndex";
	private final static String wsDataDir = "D:\\workspace\\opensource\\lucene\\src\\lia\\meetlucene\\data";
	...
	public static void main(String[] args) throws Exception {
		...
		String indexDir = wsIndexDir; // 1
		String dataDir = wsDataDir; // 2
	...
	public Indexer(String indexDir) throws IOException {
		...
		writer.setInfoStream(System.out);// used for debugging.
	}
	...
	protected Document getDocument(File f) throws Exception {
		...
		// make specific document in front of the searching results.
		if (f.getName().toUpperCase().contains("FREEBSD")) {
			doc.setBoost(1.5F);
		} else if(f.getName().toUpperCase().contains("MIT")){
			doc.setBoost(0.1F);
		}
		return doc;
	}
